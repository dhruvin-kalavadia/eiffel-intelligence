...
A step by step example will be presented using [artifact aggregation rules](../src/main/resources/rules/ArtifactRules-Eiffel-Agen-Version.json).

Assume that an EiffelArtifactCreatedEvent is received and the upstream response
tree contains several Eiffel events, which could look like [this](../src/test/resources/upStreamResultFile.json).
